...
$translations = [
    'en' => [
        ...
        'sidebar_sales' => 'SALES',
        'sidebar_order_inbox' => 'Order Inbox',
        'sidebar_orders' => 'Orders',
        'sidebar_delivery_dispatch' => 'Delivery Dispatch',
        'sidebar_archive' => 'Archive',
        'sidebar_production' => 'PRODUCTION',
        'sidebar_production_orders' => 'Production Orders',
        'sidebar_mix_batches' => 'Mix Batches',
        'sidebar_mixing_station' => 'Mixing Station',
        'sidebar_curing_station' => 'Curing Station',
        'sidebar_finish_production' => 'Finish Production',
        'sidebar_mix_recipes' => 'Mix Recipes',
        'sidebar_request_materials' => 'Request Materials',
        'sidebar_order_pipeline' => 'Order Pipeline',
        'sidebar_procurement_group' => 'PROCUREMENT',
        'sidebar_procurement' => 'Procurement Home',
        'sidebar_suppliers' => 'Suppliers',
        'sidebar_create_po' => 'Create PO',
        'sidebar_track_orders' => 'Track Orders',
        'sidebar_receive_orders' => 'Receive Orders',
        'sidebar_incoming_requests' => 'Incoming Requests',
        'sidebar_rop_alerts' => 'ROP Alerts',
        'sidebar_management' => 'MANAGEMENT',
        'sidebar_inventory' => 'Inventory',
        'sidebar_hr' => 'HR',
        'sidebar_careers' => 'Careers Pipeline',
        'sidebar_accounting' => 'Accounting',
        'sidebar_invoices' => 'Invoices',
        'sidebar_bi' => 'Business Intelligence',
        'sidebar_math_models' => 'Math Models',
        'sidebar_reports' => 'Reports',
        'sidebar_user_accounts' => 'User Accounts',
    ],
    'ar' => [
        // Storefront Nav
        'home' => 'الرئيسية',
        ...
        'sidebar_order_inbox' => 'صندوق الطلبات',
        'sidebar_orders' => 'الطلبات',
        'sidebar_delivery_dispatch' => 'إرسال التوصيل',
        'sidebar_archive' => 'الأرشيف',
        'sidebar_production' => 'الإنتاج',
        'sidebar_production_orders' => 'أوامر الإنتاج',
        'sidebar_mix_batches' => 'دفعات الخلط',
        'sidebar_mixing_station' => 'محطة الخلط',
        'sidebar_curing_station' => 'محطة المعالجة',
        'sidebar_finish_production' => 'إنهاء الإنتاج',
        'sidebar_mix_recipes' => 'وصفات الخلط',
        'sidebar_request_materials' => 'طلب مواد',
        'sidebar_order_pipeline' => 'خط الطلبات',
        'sidebar_procurement_group' => 'المشتريات',
        'sidebar_procurement' => 'إدارة المشتريات',
        'sidebar_suppliers' => 'الموردون',
        'sidebar_create_po' => 'إنشاء أمر شراء',
        'sidebar_track_orders' => 'تتبع الطلبات',
        'sidebar_receive_orders' => 'استلام الطلبات',
        'sidebar_incoming_requests' => 'الطلبات الواردة',
        'sidebar_rop_alerts' => 'تنبيهات إعادة الطلب',
        'sidebar_management' => 'الإدارة',
        'sidebar_inventory' => 'المخزون',
        'sidebar_hr' => 'الموارد البشرية',
        'sidebar_careers' => 'خط الوظائف',
        'sidebar_accounting' => 'المحاسبة',
        'sidebar_invoices' => 'الفواتير',
        'sidebar_bi' => 'ذكاء الأعمال',
        'sidebar_math_models' => 'النماذج الرياضية',
        'sidebar_reports' => 'التقارير',
        'sidebar_user_accounts' => 'حسابات المستخدمين',
    ],
];
