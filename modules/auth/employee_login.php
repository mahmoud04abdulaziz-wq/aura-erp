...
<body>
    <div class="app-container" style="min-height: 100vh; display: flex; align-items: center; justify-content: center; position: relative;">
        ...
        <div class="login-page">
            <div class="login-card">
                ...
                <form method="POST" autocomplete="on">
                    ...
                    <div style="text-align: center; margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid #e5e7eb; font-size: 0.9rem; color: #6b7280;">
                        <i class="fa-solid fa-user" style="margin-right: 4px;"></i> Not an employee? 
                        <a href="login.php" style="color: #6366f1; text-decoration: none; font-weight: 500;">Customer Login</a>
                    </div>
                </form>
            </div>
        </div>
